...
public class XuberApplication extends Application {

    public static final String TAG = XuberApplication.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static XuberApplication mInstance;
    ...
    public static synchronized XuberApplication getInstance() {
        return mInstance;
    }
